        ...
        <div class="register-main w1200">
            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="register-main-msg">
                <el-form-item prop="userName">
                    <el-input v-model="ruleForm.userName" placeholder="输入真实姓名">
                ...
                <div class="website-location checkedAgreed">
                    <el-checkbox v-model="ruleForm.checkedLogin"></el-checkbox>
                    <el-link :underline="false">我已阅读并同意准买网《服务协议》</el-link>
                </div>
